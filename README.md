...
[![Version](https://img.shields.io/badge/version-2.4-blue.svg)](https://github.com/johnnyh1975/ha_roomba_plus_card/releases)
...
> Full v2.4 feature set (mission coverage replay including cloud-source rows, room accessibility scoring, per-room suggested cleaning intervals, an Auto-clean dirty rooms trigger, and mission-map rotation) needs integration ≥ **3.4.2** — everything degrades gracefully on older versions, feature by feature.
